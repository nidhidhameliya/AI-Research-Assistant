...
async def _extract_image_vision(file_path: Path) -> str:
    """Use Groq vision model to extract text and structure from architecture images."""
    if not settings.groq_api_key:
        return f"[Image: {file_path.name}] - Vision extraction skipped: GROQ_API_KEY is not configured."
